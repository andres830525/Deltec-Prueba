@extends('layouts.sidebar', ['activePage' => 'recursos', 'titlePage' => 'Detalles del recurso'])
@section('content')
<div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">Vista detallada de {{ $recurso->name }}</p>
          </div>
          <!--End header-->
          <!--Body-->
          <div class="card-body">
                  ...
                  <div class="card-body">
                    <p class="card-text">
                      <div class="author">
                        ...
                        <a href="#">
                          <img  src="{{ asset('/img/lenovo.jpg') }}" alt="">
                          <h5 class="title mt-3"> {{ $recurso->name }}</h5>
                        </a>
                        <p class="description">
                          {{ _('Ceo/Co-Founder') }} <br>
